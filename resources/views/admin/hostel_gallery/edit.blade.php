...
@section('title'," | Edit Hostels Tag")
...
<div class="kt-subheader__main"> 
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<a href="{{ route('gallery.home') }}" class="kt-subheader__breadcrumbs-link">Hostels Tags</a>
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Edit Hostels Tag</a>
	...
	<div class="row mt-3">
		<div class="col-12">
			<!--begin::Portlet-->
						<div class="kt-portlet">
							...
							<!--begin::Form-->
							<form class="kt-form" method="POST" action="{{ route('gallery.update', ['id'=>$edit->id]) }}">
								@csrf
								@if ($errors->any())
		...
		<label class="col-2 col-form-label">Active Status</label>
							...
							<div class="col-12  col-lg-6	">
										...
										<select class="form-control" name="hostel_id"><option value="">Select Hostels</option>
								
									<option <?php if($edit->hostel_id)?>></option>
										</select>
									</div>
													...
													<div class="col-6">
														<label>Name</label>
														<input class="form-control" type="text" name="image_name" value="{{ $edit->name }}" placeholder="Enter Page Name"><br />
													</div>
