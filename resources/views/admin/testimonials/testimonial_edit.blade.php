...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Edit Testimonial</a>
		...
		<div class="col-12">
			<!--begin::Portlet-->
						<div class="kt-portlet">
							...
							<!--begin::Form-->
							<form class="kt-form" method="POST" action="{{ route('testimonial.update', ['slug'=>$edit->slug]) }}" enctype="multipart/form-data">
								@csrf
								...
								@endif
										<div class="row">
											...
											<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
												...
												<input class="form-control" type="text" name="designation" value="{{ $edit->designation }}" placeholder="Enter Designation"><br />
											</div>
											<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
												<div class="form-group">
													<label>Profile Image</label>
													<input type="file" name="profile_pic" class="form-control-file">
													currently :- <a href="{{ asset('storage/app/team_members_pic/'.$edit->profile_pic ) }}" target="_blank">{{ $edit->profile_pic }}</a>
												</div>
											</div>
											<div class="col-12">
												<label>Intro</label>
												<textarea id="editor1" class="form-control" rows="3" type="text" name="info" placeholder="Enter lab intro">{{ $edit->info }}</textarea><br />
											</div>
										</div>
											<!--end::Portlet-->
									</div>
