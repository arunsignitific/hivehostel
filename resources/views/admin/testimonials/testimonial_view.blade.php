...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Testimonial View</a>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-3">
										<label>Testimonial Id :</label> {{ $showone->id }}<hr />
									</div>
									<div class="col-3">
										<label>Name :</label> {{ $showone->name }}<hr />
									</div>
									<div class="col-3">
										<label>Testimonial-slug :</label> {{ $showone->slug }}<hr />
									</div>
									<div class="col-3">
										<label>Designation :</label> {{ $showone->designation }}<hr />
									</div>
									<div class="col-12">
										<label>Message : -</label><br /><br /> {!! $showone->info !!}<hr />
									</div>
									<div class="col-12">
										<label>Profile Image :</label><br />
										<a href="{{ asset('storage/app/testimonial_members_pic/'.$showone->profile_pic ) }}" target="_blank">
											<img src="{{ asset('storage/app/testimonial_members_pic/'.$showone->profile_pic ) }}" style="max-width:300px; max-height:180px;" /><hr />
										</a>
									</div>
								</div>
							</div>
