...
@section('title'," | Add Universitiy Tag")
@section('linkfile')
@endsection
@section('subheader')
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<a href="{{ route('amenities.home') }}" class="kt-subheader__breadcrumbs-link">Universitiy Tags</a>
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Add Universitiy Tag</a>
			...
			<div class="kt-portlet">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Add Universitiy Tag</h3>
					</div>
					<div class="kt-portlet__head-toolbar">
						<div class="kt-portlet__head-wrapper">
							<a href="{{ route('university.home') }}" class="btn btn-primary btn-icon-sm">
				...
				<!--begin::Form-->
				<form class="kt-form" method="POST" action="{{ route('university.insert') }}" enctype="multipart/form-data">
					@csrf
					<!--begin::Portlet-->
							...
							<div class="col-10 mb-5">
								<span class="kt-switch kt-switch--icon">
									<label>
										...
										<label>Name</label>
										<input class="form-control" type="text" name="university_name" placeholder="Enter University Name"><br />
									</div>
