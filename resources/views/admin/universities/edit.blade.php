...
@section('title'," | Edit University Tag")
...
<a href="{{ route('university.home') }}" class="kt-subheader__breadcrumbs-link">University Tags</a>
<span class="kt-subheader__breadcrumbs-separator"></span>
<a href="" class="kt-subheader__breadcrumbs-link">Edit University Tag</a>
...
<!--begin::Form-->
<form class="kt-form" method="POST" action="{{ route('university.update', ['id'=>$edit->id]) }}">
	@csrf
	@if ($errors->any())
...
<label class="col-2 col-form-label">Active Status</label>
				<div class="col-10 mb-5">
					...
					<div class="row">
						<div class="col-12">
							<label>Name</label>
							<input class="form-control" type="text" name="university_name" value="{{ $edit->name }}" placeholder="Enter university Name"><br />
						</div>
					</div>
					</div>
