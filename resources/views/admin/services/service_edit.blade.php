...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Edit Service</a>
		...
		<div class="col-12">
			<!--begin::Portlet-->
						<div class="kt-portlet">
							...
							<!--begin::Form-->
							<form class="kt-form" method="POST" action="{{ route('service.update', ['slug'=>$edit->slug]) }}" enctype="multipart/form-data">
								@csrf
								@if ($errors->any())
											...
											<div class="tab-content">
												...
												<div class="row">
													...
													<div class="col-12">
														...
														<input class="form-control" type="text" name="banner_heading" value="{{ $edit->banner_heading }}" placeholder="Enter Banner Heading"><br />
													</div>
													<div class="col-12">
														<label>H2 Heading</label>
														<input class="form-control" type="text" name="h2" value="{{ $edit->h2 }}" placeholder="Enter H2 Heading"><br />
													</div>
													<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
														<div class="form-group">
															<label>Header Image</label>
															<input type="file" name="header_img" class="form-control-file">
															currently :- <a href="{{ asset('storage/app/service_pics/'.$edit->header_img ) }}" target="_blank">{{ $edit->header_img }}</a>
														</div>
													</div>
													<div class="col-12">
														<label>Post</label>
												...
												<div class="tab-pane" id="kt_portlet_base_demo_3_2_tab_content" role="tabpanel">
													...
													<div class="col-12">
														...
														<input class="form-control" type="text" name="meta_keyword" value="{{ $edit->meta_keyword }}" placeholder="Enter meta Keyword"><br />
													</div>
												</div>
