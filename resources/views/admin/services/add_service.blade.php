...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Add Service</a>
			...
			<div class="kt-portlet">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Add Service</h3>
					</div>
				...
				<!--begin::Form-->
				<form class="kt-form" method="POST" action="{{ route('service.insert') }}" enctype="multipart/form-data">
					@csrf
					<!--begin::Portlet-->
												...
												<div class="tab-pane active" id="kt_portlet_base_demo_3_3_tab_content" role="tabpanel">
													<div class="row">
														...
														<div class="col-12">
															...
															<input class="form-control" type="text" name="banner_heading" placeholder="Enter Banner Heading"><br />
														</div>
														<div class="col-12">
															<label>H2 Heading</label>
															<input class="form-control" type="text" name="h2" placeholder="Enter H2 Heading"><br />
														</div>
														...
														<div class="col-12">
															<label>Post</label>
															<textarea id="editor1" class="form-control" rows="3" type="text" name="post" placeholder="Enter Post"></textarea><br />
														</div>
													</div>
												</div>
