...
@section('title'," | Edit pincode Tag")
...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<a href="{{ route('pincode.home') }}" class="kt-subheader__breadcrumbs-link">pincode Tags</a>
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Edit pincode Tag</a>
		...
		<div class="col-12">
			<!--begin::Portlet-->
						<div class="kt-portlet">
							...
							<!--begin::Form-->
							<form class="kt-form" method="POST" action="{{ route('pincode.update', ['id'=>$edit->id]) }}">
								@csrf
								@if ($errors->any())
					...
					<span class="kt-switch kt-switch--icon">
						<label>
							...
							<span></span>
													...
													<div class="col-12">
														<label>Name</label>
														<input class="form-control" type="text" name="pincode_name" value="{{ $edit->name }}" placeholder="Enter pincode Name"><br />
													</div>
												</div>
												</div>
