...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<a href="{{ route('amenities.home') }}" class="kt-subheader__breadcrumbs-link">Pincode Tags</a>
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Add Pincode Tag</a>
			...
			<div class="kt-portlet">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Add Pincode Tag</h3>
					</div>
					<div class="kt-portlet__head-toolbar">
						<div class="kt-portlet__head-wrapper">
							<a href="{{ route('pincode.home') }}" class="btn btn-primary btn-icon-sm">
				...
				<!--begin::Form-->
				<form class="kt-form" method="POST" action="{{ route('pincode.insert') }}" > 
					@csrf
					<!--begin::Portlet-->
							...
							<div class="col-10 mb-5">
								<span class="kt-switch kt-switch--icon">
									<label>
										...
										<label>Name</label>
										<input class="form-control" type="text" name="pincode_name" placeholder="Enter Pincode Name"><br />
									</div>
