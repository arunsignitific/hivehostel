...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Add Blog</a>
			...
			<div class="kt-portlet">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Add Blog</h3>
					</div>
				...
				<!--begin::Form-->
				<form class="kt-form" method="POST" action="{{ route('blog.insert') }}" enctype="multipart/form-data">
					@csrf
					<!--begin::Portlet-->
														...
														<div class="col-6">
															...
															<select class="form-control select" name="blog_author_id">
																...
																@foreach ($blog_authors as $data)
																	<option value="{{ $data->id }}" @if ($data->name == 'Polo Elevators') selected @endif>{{ $data->name }}</option>
																@endforeach
															</select>
															<br />
														</div>
