...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<a href="{{ route('seo.home') }}" class="kt-subheader__breadcrumbs-link">Area</a>
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Area Search</a>
							...
							<div class="row align-items-center">
								<div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
									<div class="kt-input-icon kt-input-icon--left">
										<form action="{{ route('area.search') }}" method="POST" role="search">
										@csrf
										...
										<?php $no = 1; ?>
											@foreach($detail as $data)
												<tr>
													...
													<td>{{ $data->name }}</td>
													<td>
														<a href="{{ route('area.view', ['id'=>$data->id]) }}" class="btn btn-outline-info btn-elevate btn-icon"><i class="flaticon-eye"></i></a>
														<a href="{{ route('area.edit', ['id'=>$data->id]) }}" class="btn btn-outline-warning btn-elevate btn-icon"><i class="flaticon-edit"></i></a>
