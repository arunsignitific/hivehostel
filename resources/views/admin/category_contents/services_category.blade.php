...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<a href="" class="kt-subheader__breadcrumbs-link">Services</a>
			...
			<div class="kt-portlet__head kt-portlet__head--lg">
				...
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						<a href="{{ url('admin/add-caterogy') }}" class="btn btn-brand btn-icon-sm">
							...
							<div class="row align-items-center">
								<div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
									<div class="kt-input-icon kt-input-icon--left">
										<form action="{{ route('service.search') }}" method="POST" role="search">
										@csrf
						...
						<div class="row">
							<div class="col-12">
								<div class="table-responsive-md">
										...
										<?php $no = 1; ?>
											@foreach($services as $data)
												<tr>
													...
													<td>{{ $data->title }}</td>
													<td>
														<a href="{{ route('service.view', ['slug'=>$data->slug]) }}" class="btn btn-outline-info btn-elevate btn-icon"><i class="flaticon-eye"></i></a>
														<a href="{{ route('service.edit', ['slug'=>$data->slug]) }}" class="btn btn-outline-warning btn-elevate btn-icon"><i class="flaticon-edit"></i></a>
									...
									{{ $services->appends(['sort' => 'votes'])->links() }}
								</div>
							</div>
						</div>
					</div>
