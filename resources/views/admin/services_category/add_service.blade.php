			...
			<div class="kt-portlet">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Add Caterogy</h3>
					</div>
				...
				<!--begin::Form-->
				<form class="kt-form" method="POST" action="{{ url('admin/insert-caterogy') }}" enctype="multipart/form-data">
					@csrf
					<!--begin::Portlet-->
													...
													<div class="row">
														...
														<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
															<div class="form-group">
																...
																<input type="file" name="catagory_image" class="form-control-file">
															</div>
														</div>
														<!-- <div class="col-12">
															<label>Post</label>
