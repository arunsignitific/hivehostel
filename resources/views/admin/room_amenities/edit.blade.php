...
@section('title'," | Edit Amenities Tag")
...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Edit Amenities Tag</a>
		...
		<div class="col-12">
			<!--begin::Portlet-->
						<div class="kt-portlet">
							...
							<!--begin::Form-->
							<form class="kt-form" method="POST" action="{{ route('amenities.update', ['id'=>$edit->id]) }}">
								@csrf
								@if ($errors->any()) 
											...
											<div class="col-10 mb-5">
												<span class="kt-switch kt-switch--icon">
													...
													<div class="col-6">
														...
														<div class="col-6">
														<label>Icon</label>
<input class="form-control" type="file" name="amenities_icon" value="{{ $edit->icon }}" ><br />
														 <img style="width: 100px; " src="{{url('storage/app/team_members_pic/')}}/{{$edit->icon}}"  >

								 <input type="hidden" name="uploded_amenities_icon" value="{{ $edit->icon }}">
