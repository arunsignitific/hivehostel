...
@section('title'," | Add Amenities Tag")
@section('linkfile')
@endsection
@section('subheader')
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<a href="{{ route('amenities.home') }}" class="kt-subheader__breadcrumbs-link">Amenities Tags</a>
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Add Amenities Tag</a>
			...
			<div class="kt-portlet">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Add Amenities Tag</h3>
					</div>
				...
				<!--begin::Form-->
				<form class="kt-form" method="POST" action="{{ route('amenities.insert') }}" enctype="multipart/form-data">
					@csrf
					<!--begin::Portlet-->
							...
							<div class="col-10 mb-5">
								<span class="kt-switch kt-switch--icon">
									<label>
										...
										<label>Name</label>
										<input class="form-control" type="text" name="amenities_name" placeholder="Enter Room Amenities Name"><br />
									</div>
									<div class="col-12  col-lg-7	">
										<label>Icon</label>
										<input class="form-control" type="file" name="amenities_icon" placeholder="Enter Room Amenities Icon"><br />
									</div>
