...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Add SEO Tag</a>
			...
			<div class="kt-portlet">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Add SEO Tag</h3>
					</div>
				...
				<!--begin::Form-->
				<form class="kt-form" method="POST" action="{{ route('seo.insert') }}">
					@csrf
					<!--begin::Portlet-->
												...
												<div class="tab-pane active" id="kt_portlet_base_demo_3_3_tab_content" role="tabpanel">
													<div class="row">
														<div class="col-12">
															...
															<input class="form-control" type="text" name="page_name" placeholder="Enter Page Name"><br />
														</div>
													</div>
												</div>
