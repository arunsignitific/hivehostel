...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<a href="" class="kt-subheader__breadcrumbs-link">Clients</a>
			...
			<div class="kt-portlet__head kt-portlet__head--lg">
				...
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						<a href="{{ route('client.add') }}" class="btn btn-brand btn-icon-sm">
							...
							<div class="row align-items-center">
								<div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
									<div class="kt-input-icon kt-input-icon--left">
										<form action="{{ route('client.search') }}" method="POST" role="search">
										@csrf
						...
						<div class="row">
							<div class="col-12">
								<div class="table-responsive-md">
										...
										<?php $no = 1; ?>
											@foreach($clients as $data)
												<tr>
													...
													<td style=""><i class="fa {{ ($data->top=='active') ? 'fa-check text-success':'fa-times text-danger' }} inline"></i></td>
													<td>
														<a href="{{ route('client.view', ['slug'=>$data->slug]) }}" class="btn btn-outline-info btn-elevate btn-icon"><i class="flaticon-eye"></i></a>
														<a href="{{ route('client.edit', ['slug'=>$data->slug]) }}" class="btn btn-outline-warning btn-elevate btn-icon"><i class="flaticon-edit"></i></a>
									...
									{{ $clients->appends(['sort' => 'votes'])->links() }}
								</div>
							</div>
						</div>
					</div>
