...
@section('title'," | Blog Category Search")
...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Blog Category Search</a>
			...
			<div class="kt-portlet__head kt-portlet__head--lg">
				...
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						<a href="{{ route('blogCategory.add') }}" class="btn btn-brand btn-icon-sm">
							...
							<div class="row align-items-center">
								<div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
									<div class="kt-input-icon kt-input-icon--left">
										<form action="{{ route('blogCategory.search') }}" method="POST" role="search">
										@csrf
										...
										<?php $no = 1; ?>
											@foreach($detail as $data)
												<tr>
													...
													<td>{{ $data->name }}</td>
													<td>
														<a href="{{ route('blogCategory.view', ['slug'=>$data->slug]) }}" class="btn btn-outline-info btn-elevate btn-icon"><i class="flaticon-eye"></i></a>
														<a href="{{ route('blogCategory.edit', ['slug'=>$data->slug]) }}" class="btn btn-outline-warning btn-elevate btn-icon"><i class="flaticon-edit"></i></a>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
		...
		<form action="{{ route('blogCategory.delete') }}" method="post">
        {{ method_field('delete')}}
		@csrf
