...
<div class="kt-subheader__main">
	...
	<div class="kt-subheader__breadcrumbs">
		...
		<span class="kt-subheader__breadcrumbs-separator"></span>
		<a href="" class="kt-subheader__breadcrumbs-link">Edit Blog Category</a>
		...
		<div class="col-12">
			<!--begin::Portlet-->
						<div class="kt-portlet">
							...
							<!--begin::Form-->
							<form class="kt-form" method="POST" action="{{ route('blogCategory.update', ['slug'=>$edit->slug]) }}" enctype="multipart/form-data">
								@csrf
								@if ($errors->any())
										...
										<div class="kt-portlet__body">
											<div class="tab-content">
												...
												<div class="row">
													...
													<div class="col-12">
														<label>Parent</label>
														<input class="form-control" type="text" name="parent" value="{{ $edit->parent }}" placeholder="Enter Parent"><br />
													</div>
													<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
														<div class="form-group">
															<label>Image</label>
															<input type="file" name="img" class="form-control-file">
															currently :- <a href="{{ asset('storage/app/blog_cat_img/'.$edit->img ) }}" target="_blank">{{ $edit->img }}</a>
														</div>
													</div>
												</div>
												</div>
